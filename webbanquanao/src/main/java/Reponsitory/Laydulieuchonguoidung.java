...
public class Laydulieuchonguoidung implements Thaotacvoigiaodiennguoidung {
	...
	public List<KhuyenMai> LayThongTinKhuyenMai(String maKhuyenMai) {
		System.out.println("khuyến mãi" + maKhuyenMai);
		...
		try {
			...
			// Câu truy vấn SQL
			String query = "SELECT * FROM khuyenmai where maKhuyeMai = ?";
	...
	public boolean updateDonHang(int id, int soLuong) {
		...
		try {
			...
			// Câu truy vấn SQL
			String query = "update donhang set soLuong=? where idDonHang=?";
	...
	public List<GioHang> LayHetThongTinGioHang() {
	    ...
	    try {
	        ...
	        while (rs.next()) {
	            ...
	            System.out.println("=====================================Dữ liệu từ ResultSet:=======================================================");
	            System.out.println("idGioHang: " + rs.getInt("idGioHang"));
	            System.out.println("MaNguoiDung: " + rs.getInt("MaNguoiDung"));
	            System.out.println("id: " + rs.getInt("id"));
	            System.out.println("mauSac: " + rs.getString("mauSac"));
	            System.out.println("kichCo: " + rs.getString("kichCo")); // Sửa lại để khớp với DB
	            System.out.println("trangThai: " + rs.getString("trangThai"));
	            System.out.println("giaTien: " + rs.getFloat("giaTien"));
	            System.out.println("soLuong: " + rs.getInt("soLuong"));
	            System.out.println("duongdananh: " + rs.getString("duongdananh"));
	            System.out.println("tensanpham: " + rs.getString("tensanpham"));
System.out.println("===================================================================");
	            list.add(gh);
	        }
	    } catch (SQLException e) {
